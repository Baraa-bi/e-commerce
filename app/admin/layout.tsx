...
export default async function AdminLayout({
  ...
  return (
    <div className="bg-gradient-to-r from-sky-100 via-gray-300 to-pink-100">
      <div className=" h-screen w-screen candy-mesh p-5">
        <>
          <aside
            id="default-sidebar"
        ...
        <div className="p-2 sm:ml-72 overflow-scroll">
