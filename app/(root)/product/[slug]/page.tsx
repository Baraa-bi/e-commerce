      ...
      <div className="container px-5 py-24 mx-auto">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div>
                ...
                <blockquote className = "p-4 my-4 border-l-4 border-gray-300 bg-gray-50 dark:border-gray-500 dark:bg-gray-800">
                    <p className = "text-xl italic font-medium leading-relaxed text-gray-900 dark:text-white">"Flowbite is just awesome. It contains tons of predesigned components and pages starting from login screen to complex dashboard. Perfect choice for your next SaaS application."</p>
                </blockquote>
                <p className = "text-gray-500 dark:text-gray-400">
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end' }}>
                    <img alt="ecommerce"
                      className="lg:w-32 object-center rounded border border-gray-200"
                      src={`/assets/products/product-1.jpg`}
                    />

                    <img alt="ecommerce"
                      className="lg:w-32 object-cover object-center rounded border border-gray-200"
